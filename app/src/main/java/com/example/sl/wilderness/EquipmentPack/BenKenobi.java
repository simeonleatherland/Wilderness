...
public class BenKenobi extends Equipment {
    ...
    public BenKenobi(String inDesc, int inValue, double inMass, int row, int col, boolean held, long id)
    {
        super(inDesc,inValue,inMass, row, col, held, id);
    }
    public BenKenobi(String inDesc, int inValue, double inMass, int row, int col, boolean held)
    {
